...
Before Claude Code, my approach to AI-assisted coding was basically: "I'll just copy-paste from ChatGPT and hope it works." 😄 I used to spend hours explaining my project context to AI assistants, repeating the same instructions in every conversation, and manually copying code back and forth between my browser and my editor.
...
Below I have covered some of claude features
1. [Claude.md File: Its Purpose And Best Practices For AI Development Workflow](./claude-features/CLAUDE.md)
2. [Slash Commands: How To Create Custom Slash Commands](./claude-features/SLASH_COMMANDS.md)
3. [Plan Mode In Claude: How To Navigate Through Different LLM Models For Different Purposes](./claude-features/PLAN_MODE.md)
4. [Claude Sub-Agents: Why They Are Useful And How Can We Use Them Efficiently ](./claude-features/CLAUDE_SUB_AGENTS.md)
5. [How To Create Our Own Custom Sub-Agents](./claude-features/CUSTOM_SUB_AGENTS.md)
